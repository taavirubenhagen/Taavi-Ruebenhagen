<script lang='ts'>
    import { Footer, Text, TextButton, InlineButton } from "$lib/v2";
...
<main class="overflow-hidden min-h-screen flex flex-col justify-center items-start p-8 sm:p-16">
    <Text large heading>
        projects.
    </Text>
    <div class="h-4"></div>
    ...
    <div class="w-full flex flex-wrap justify-start gap-4">
        ...
        <!.--<TextButton href="https://hoffmanns-schuppen.com">
            <span class="normal-case">
